...
def make_menu():
    ...
    with open(r"resource_files\alberta_wildfire_icon.ico", "rb") as f:
        icon_data = f.read()

    # Convert the binary data to base64
    icon_base64 = base64.b64encode(icon_data).decode()

    # Define custom CSS to style the image and position it in the top left corner
    custom_css = """
    <style>
    .sidebar-image {
    ...
    # Display the logo in the sidebar with the custom CSS class
    st.sidebar.markdown(
        f'<img src="data:image/x-icon;base64,{icon_base64}" alt="logo" class="sidebar-image">',
