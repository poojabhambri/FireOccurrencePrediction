...
def make_menu():
    ...
    raw_weather_file = st.file_uploader("Load raw weather data input... the data is used in both models for lightning and human-caused fire prediction. Include the most recent weather data for accurate forecasts.", type=["csv", "txt"])
    if raw_weather_file:
